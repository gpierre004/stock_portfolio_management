          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 rounded p-3">
              ...
              <div className="space-y-2 mt-2">
                {signals.indicators.supportResistance.support.map((level, index) => (
            ...
            <div className="bg-gray-50 rounded p-3">
              ...
              <div className="space-y-2 mt-2">
                {signals.indicators.supportResistance.resistance.map((level, index) => (
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
              <div>
                ...
                <p className="text-sm text-gray-500">{signals.signals.supportResistance.message}</p>
              </div>
              <SignalIndicator signal={signals.signals.supportResistance} />
            </div>
          </div>
        </div>
      </div>
