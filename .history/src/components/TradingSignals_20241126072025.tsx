          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 rounded p-3">
              ...
              {supportResistance.support[0] ? (
                <div className="mt-2">
                  <div className="text-lg font-semibold">${supportResistance.support[0].level}</div>
                  <div className="text-sm text-gray-500">
                    {Math.abs(supportResistance.support[0].distance)}% away
                  </div>
                </div>
              ) : (
            ...
            <div className="bg-gray-50 rounded p-3">
              ...
              {supportResistance.resistance[0] ? (
                <div className="mt-2">
                  <div className="text-lg font-semibold">${supportResistance.resistance[0].level}</div>
                  <div className="text-sm text-gray-500">
                    {Math.abs(supportResistance.resistance[0].distance)}% away
                  </div>
                </div>
              ) : (
