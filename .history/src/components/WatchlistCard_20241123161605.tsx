...
const WatchlistCard = ({ item, onRemove, onToggleInterested }: WatchlistCardProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <IconButton
          size="small"
          onClick={() => onToggleInterested(item.id, !item.interested)}
          color={item.interested ? 'primary' : 'default'}
        >
          {item.interested ? <StarIcon /> : <StarOutlineIcon />}
        </IconButton>
        <IconButton
          size="small"
